    ...
    class ScrollLoad {
        constructor(opt) {
            ...
            const DEFAULT = {
                ...
                loadEffectTemplate: LOADEFFECT_TPL //loading效果的模板
            }
            ...
            // 创建loading
            this.loadEffect = $(this.loadEffectTemplate).appendTo(this.listContanier)
        ...
        reload(reload_callback) {
            ...
            // 还原loading的效果
            this.loadEffect.replaceWith(this.loadEffectTemplate)
